...
export default function AdminPanel({ onBack }) {
  ...
  const stats = useMemo(() => {
    ...
    const activeTasks = tasks.filter(
      (t) => t.status === "In Progress" || t.status === "Scheduled",
    ).length;
    return {
      completedTasks,
      activeTasks,
  ...
  const feedbackRows = filter(feedback, [
    "id",
    "customer",
    "worker",
    "task",
  ...
  const paymentRows = filter(payments, [
    "paymentid",
    "customer_name",
    "worker_name",
    "task_title",
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6">
          ...
          <div className="mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
            ...
            <StatCard
              ...
              sub={`${stats.activeTasks} active now`}
